...
const addProduct = asyncHandler(async (req, res) => {
    console.log("Here in addProduct....", req.body)
    try {
        const formObject = req.body
        const item = {
            user: "638a70f9965d041004f30003",
        ...
        const product = await Product.create(item).then(val => {
            console.log('val', val)
            res.sendStatus(200);
...
const getProductByUserId = asyncHandler(async (req, res) => {
    console.log("Here in getAllProducts....", req.params.id);
